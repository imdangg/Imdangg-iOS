    ...
    func toDTO() -> InsightDTO {
        return InsightDTO(
            ...
            address: InsightDTO.Address(
                siDo: self.adress.siDo,
                siGunGu: self.adress.siGungu,
                eupMyeonDong: self.adress.eupMyeonDong,
                roadName: self.adress.roadName ?? "",
                buildingNumber: self.adress.buildngNumber,
                detail: self.adress.detail ?? "",
                latitude: 0.0,
                longitude: 0.0
            ),
            apartmentComplex: InsightDTO.ApartmentComplex(name: self.apartmentComplex),
